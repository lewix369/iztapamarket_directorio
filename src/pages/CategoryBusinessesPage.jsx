...
const CategoryBusinessesPage = () => {
  ...
  if (!categoriaEncontrada) {
    return (
      <div className="p-6">
        <h1 className="text-2xl font-bold mb-4 text-red-600">Error: Slug de categoría inválido</h1>
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Negocios en la categoría: {categoriaNombre}</h1>
