...
export const categories = [
  ...
  { name: 'Belleza', slug: 'belleza', icon: SprayCan, description: "Estéticas, barberías, spas, uñas.", dbName: 'Belleza' },
  { name: 'Servicios', slug: 'servicios', icon: Home, description: "Plomería, electricidad, limpieza y más.", dbName: 'Servicios' },
  { name: 'Moda', slug: 'moda', icon: Shirt, description: "Ropa, accesorios, calzado y regalos.", dbName: 'Moda' },
  ...
  { name: 'Abarrotes', slug: 'abarrotes', icon: Package, description: "Tiendas de abarrotes, productos básicos y misceláneas.", dbName: 'Abarrotes' },
  { name: 'Autos', slug: 'autos', icon: Package, description: "Mecánica, refacciones y talleres automotrices.", dbName: 'Autos' },
