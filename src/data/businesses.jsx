...
export const initialBusinesses = [
  ...
  {
    id: '6',
    name: 'Tacos Don Memo (Ejemplo Anterior)',
    description: 'Taquería tradicional con más de 20 años sirviendo tacos al pastor, suadero y campechanos en Iztapalapa.',
    category: 'Alimentos y Bebidas',
    whatsapp: '5215512345678',
    address: 'Av. Ermita Iztapalapa 321, CDMX',
    images: ['https://images.unsplash.com/photo-1600891964599-f61ba0e24092?auto=format&fit=crop&w=800&q=80'],
    logoUrl: 'https://images.unsplash.com/photo-1600891964599-f61ba0e24092?auto=format&fit=crop&w=200&q=80', 
    hours: 'L-D: 1pm - 11pm', 
    menuUrl: 'https://wa.me/5215512345678',
    promotion: '¡Pastor especial todos los días!', 
  },
  {
    id: '7',
    name: 'Tacos Don Memo',
    description: 'Taquería tradicional con tacos al pastor, suadero y campechanos. 20 años de sabor auténtico en Iztapalapa.',
    category: 'Alimentos y Bebidas',
    ...
    logoUrl: 'https://images.unsplash.com/photo-1600891964599-f61ba0e24092?auto=format&fit=crop&w=200&q=80',
    hours: 'L-D: 1pm - 11pm', 
    promotion: '¡Nuevos Tacos Don Memo! Sabor auténtico.',
    menuItems: [
      { name: 'Taco al pastor', price: '$15' },
      { name: 'Suadero', price: '$17' },
      { name: 'Campechano', price: '$20' },
      { name: 'Quesadilla de bistec', price: '$22' },
      { name: 'Agua fresca', price: '$12' },
      { name: 'Combo (5 tacos + bebida)', price: '$80' },
    ]
  }
];
